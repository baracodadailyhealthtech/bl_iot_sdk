...
#ifndef _BFL_BLE_MESH_GENERIC_MODEL_API_H_
 ...
 */
#define BFL_BLE_MESH_MODEL_GEN_DEF_TRANS_TIME_CLI(cli_pub, cli_data)            \
        BT_MESH_MODEL_CB(BFL_BLE_MESH_MODEL_ID_GEN_DEF_TRANS_TIME_CLI,NULL, cli_pub,    \
                    cli_data, &bt_mesh_gen_def_trans_time_cli_cb)

/** @def    BFL_BLE_MESH_MODEL_GEN_POWER_ONOFF_CLI
 *
...
} bfl_ble_mesh_gen_power_range_set_t;
...
} bfl_ble_mesh_gen_loc_global_set_t;
...
} bfl_ble_mesh_gen_admin_property_set_t;
...
} bfl_ble_mesh_gen_manufacturer_property_get_t;

/** Parameters of Generic Manufacturer Property Set. */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic Manufacturer Property */
    uint8_t  user_access;   /*!< Enumeration indicating user access */
} bfl_ble_mesh_gen_manufacturer_property_set_t;

/** Parameter of Generic Client Properties Get. */
typedef struct {
    uint16_t property_id;   /*!< A starting Client Property ID present within an element */
} bfl_ble_mesh_gen_client_properties_get_t;

/**
 * @brief Generic Client Model get message union
 */
typedef union {
    bfl_ble_mesh_gen_user_property_get_t         user_property_get;         /*!< For BFL_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_GET */
    bfl_ble_mesh_gen_admin_property_get_t        admin_property_get;        /*!< For BFL_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_GET*/
    bfl_ble_mesh_gen_manufacturer_property_get_t manufacturer_property_get; /*!< For BFL_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET */
    bfl_ble_mesh_gen_client_properties_get_t     client_properties_get;     /*!< For BFL_BLE_MESH_MODEL_OP_GEN_CLIENT_PROPERTIES_GET */
} bfl_ble_mesh_generic_client_get_state_t;

/**
 * @brief Generic Client Model set message union
 */
typedef union {
    bfl_ble_mesh_gen_onoff_set_t          onoff_set;            /*!< For BFL_BLE_MESH_MODEL_OP_GEN_ONOFF_SET & BFL_BLE_MESH_MODEL_OP_GEN_ONOFF_SET_UNACK */
    bfl_ble_mesh_gen_level_set_t          level_set;            /*!< For BFL_BLE_MESH_MODEL_OP_GEN_LEVEL_SET & BFL_BLE_MESH_MODEL_OP_GEN_LEVEL_SET_UNACK */
    bfl_ble_mesh_gen_delta_set_t          delta_set;            /*!< For BFL_BLE_MESH_MODEL_OP_GEN_DELTA_SET & BFL_BLE_MESH_MODEL_OP_GEN_DELTA_SET_UNACK */
    bfl_ble_mesh_gen_move_set_t           move_set;             /*!< For BFL_BLE_MESH_MODEL_OP_GEN_MOVE_SET & BFL_BLE_MESH_MODEL_OP_GEN_MOVE_SET_UNACK */
    bfl_ble_mesh_gen_def_trans_time_set_t def_trans_time_set;   /*!< For BFL_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_SET & BFL_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_SET_UNACK */
    bfl_ble_mesh_gen_onpowerup_set_t      power_set;            /*!< For BFL_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_SET & BFL_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_SET_UNACK */
    bfl_ble_mesh_gen_power_level_set_t    power_level_set;      /*!< For BFL_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_SET & BFL_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_SET_UNACK */
    bfl_ble_mesh_gen_power_default_set_t  power_default_set;    /*!< For BFL_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_SET & BFL_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_SET_UNACK */
    bfl_ble_mesh_gen_power_range_set_t    power_range_set;      /*!< For BFL_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_SET & BFL_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_SET_UNACK */
    bfl_ble_mesh_gen_loc_global_set_t     loc_global_set;       /*!< For BFL_BLE_MESH_MODEL_OP_GEN_LOC_GLOBAL_SET & BFL_BLE_MESH_MODEL_OP_GEN_LOC_GLOBAL_SET_UNACK */
    bfl_ble_mesh_gen_loc_local_set_t      loc_local_set;        /*!< For BFL_BLE_MESH_MODEL_OP_GEN_LOC_LOCAL_SET & BFL_BLE_MESH_MODEL_OP_GEN_LOC_LOCAL_SET_UNACK */
    bfl_ble_mesh_gen_user_property_set_t  user_property_set;    /*!< For BFL_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET & BFL_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET_UNACK */
    bfl_ble_mesh_gen_admin_property_set_t admin_property_set;   /*!< For BFL_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET & BFL_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET_UNACK */
    bfl_ble_mesh_gen_manufacturer_property_set_t manufacturer_property_set; /*!< For BFL_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET & BFL_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET_UNACK */
} bfl_ble_mesh_generic_client_set_state_t;
...
} bfl_ble_mesh_gen_onoff_status_cb_t;
...
typedef struct {
    ...
    uint8_t remain_time;    /*!< Time to complete state transition (C.1) */
} bfl_ble_mesh_gen_level_status_cb_t;

/** Parameter of Generic Default Transition Time Status. */
typedef struct {
    uint8_t trans_time;     /*!< The value of the Generic Default Transition Time state */
} bfl_ble_mesh_gen_def_trans_time_status_cb_t;

/** Parameter of Generic OnPowerUp Status. */
typedef struct {
    uint8_t onpowerup;      /*!< The value of the Generic OnPowerUp state */
} bfl_ble_mesh_gen_onpowerup_status_cb_t;
...
typedef struct {
    ...
    uint16_t range_min;     /*!< Value of Range Min field of Generic Power Range state */
    uint16_t range_max;     /*!< Value of Range Max field of Generic Power Range state */
} bfl_ble_mesh_gen_power_range_status_cb_t;
...
} bfl_ble_mesh_gen_battery_status_cb_t;
...
typedef struct {
    ...
    int32_t global_longitude; /*!< Global Coordinates (Longitude) */
    int16_t global_altitude;  /*!< Global Altitude */
} bfl_ble_mesh_gen_loc_global_status_cb_t;
...
typedef struct {
    ...
    uint8_t  floor_number;    /*!< Floor Number */
    uint16_t uncertainty;     /*!< Uncertainty */
} bfl_ble_mesh_gen_loc_local_status_cb_t;
...
} bfl_ble_mesh_gen_user_properties_status_cb_t;
...
} bfl_ble_mesh_gen_user_property_status_cb_t;
...
} bfl_ble_mesh_gen_admin_properties_status_cb_t;
...
} bfl_ble_mesh_gen_admin_property_status_cb_t;
...
} bfl_ble_mesh_gen_manufacturer_properties_status_cb_t;
...
} bfl_ble_mesh_gen_manufacturer_property_status_cb_t;
...
} bfl_ble_mesh_gen_client_properties_status_cb_t;

/**
 * @brief Generic Client Model received message union
 */
typedef union {
    bfl_ble_mesh_gen_onoff_status_cb_t             onoff_status;            /*!< For BFL_BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS */
    bfl_ble_mesh_gen_level_status_cb_t             level_status;            /*!< For BFL_BLE_MESH_MODEL_OP_GEN_LEVEL_STATUS */
    bfl_ble_mesh_gen_def_trans_time_status_cb_t    def_trans_time_status;   /*!< For BFL_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_STATUS */
    bfl_ble_mesh_gen_onpowerup_status_cb_t         onpowerup_status;        /*!< For BFL_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_STATUS */
    bfl_ble_mesh_gen_power_level_status_cb_t       power_level_status;      /*!< For BFL_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_STATUS */
    bfl_ble_mesh_gen_power_last_status_cb_t        power_last_status;       /*!< For BFL_BLE_MESH_MODEL_OP_GEN_POWER_LAST_STATUS */
    bfl_ble_mesh_gen_power_default_status_cb_t     power_default_status;    /*!< For BFL_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_STATUS */
    bfl_ble_mesh_gen_power_range_status_cb_t       power_range_status;      /*!< For BFL_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_STATUS */
    bfl_ble_mesh_gen_battery_status_cb_t           battery_status;          /*!< For BFL_BLE_MESH_MODEL_OP_GEN_BATTERY_STATUS */
    bfl_ble_mesh_gen_loc_global_status_cb_t        location_global_status;  /*!< For BFL_BLE_MESH_MODEL_OP_GEN_LOC_GLOBAL_STATUS */
    bfl_ble_mesh_gen_loc_local_status_cb_t         location_local_status;   /*!< BFL_BLE_MESH_MODEL_OP_GEN_LOC_LOCAL_STATUS */
    bfl_ble_mesh_gen_user_properties_status_cb_t   user_properties_status;  /*!< BFL_BLE_MESH_MODEL_OP_GEN_USER_PROPERTIES_STATUS */
    bfl_ble_mesh_gen_user_property_status_cb_t     user_property_status;    /*!< BFL_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_STATUS */
    bfl_ble_mesh_gen_admin_properties_status_cb_t  admin_properties_status; /*!< BFL_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTIES_STATUS */
    bfl_ble_mesh_gen_admin_property_status_cb_t    admin_property_status;   /*!< BFL_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_STATUS */
    bfl_ble_mesh_gen_manufacturer_properties_status_cb_t manufacturer_properties_status; /*!< BFL_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTIES_STATUS */
    bfl_ble_mesh_gen_manufacturer_property_status_cb_t   manufacturer_property_status;   /*!< BFL_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_STATUS */
    bfl_ble_mesh_gen_client_properties_status_cb_t       client_properties_status;       /*!< BFL_BLE_MESH_MODEL_OP_GEN_CLIENT_PROPERTIES_STATUS */
} bfl_ble_mesh_gen_client_status_cb_t;
...
typedef struct {
    ...
    bfl_ble_mesh_gen_client_status_cb_t status_cb;  /*!< The generic status message callback values */
} bfl_ble_mesh_generic_client_cb_param_t;

/** This enum value is the event of Generic Client Model */
typedef enum {
    BFL_BLE_MESH_GENERIC_CLIENT_GET_STATE_EVT,
    BFL_BLE_MESH_GENERIC_CLIENT_SET_STATE_EVT,
    BFL_BLE_MESH_GENERIC_CLIENT_PUBLISH_EVT,
    BFL_BLE_MESH_GENERIC_CLIENT_TIMEOUT_EVT,
    BFL_BLE_MESH_GENERIC_CLIENT_EVT_MAX,
} bfl_ble_mesh_generic_client_cb_event_t;
 ...
 */
typedef void (* bfl_ble_mesh_generic_client_cb_t)(bfl_ble_mesh_generic_client_cb_event_t event,
 ...
 *
 */
bfl_err_t bfl_ble_mesh_register_generic_client_callback(bfl_ble_mesh_generic_client_cb_t callback);
 ...
 *              please refer to bfl_ble_mesh_generic_message_opcode_t in bfl_ble_mesh_defs.h
 *
 ...
 *
 */
bfl_err_t bfl_ble_mesh_generic_client_get_state(bfl_ble_mesh_client_common_param_t *params,
 ...
 *
 */
bfl_err_t bfl_ble_mesh_generic_client_set_state(bfl_ble_mesh_client_common_param_t *params,
        bfl_ble_mesh_generic_client_set_state_t *set_state);
 ...
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_onoff_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_level_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_def_trans_time_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_power_onoff_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_power_onoff_setup_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_power_level_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_power_level_setup_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_battery_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_location_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_location_setup_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_user_prop_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_admin_prop_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_manu_prop_srv_t.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct bfl_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct bfl_ble_mesh_gen_client_prop_srv_t.
 *
...
} bfl_ble_mesh_gen_onoff_state_t;

/** User data of Generic OnOff Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Generic OnOff Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_onoff_state_t state;       /*!< Parameters of the Generic OnOff state */
...
} bfl_ble_mesh_gen_level_state_t;

/** User data of Generic Level Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Generic Level Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_level_state_t state;       /*!< Parameters of the Generic Level state */
    bfl_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    bfl_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
    int32_t tt_delta_level;                     /*!< Delta change value of level state transition */
} bfl_ble_mesh_gen_level_srv_t;

/** Parameter of Generic Default Transition Time state */
typedef struct {
    uint8_t trans_time;     /*!< The value of the Generic Default Transition Time state */
} bfl_ble_mesh_gen_def_trans_time_state_t;

/** User data of Generic Default Transition Time Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Default Transition Time Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_def_trans_time_state_t state;  /*!< Parameters of the Generic Default Transition Time state */
} bfl_ble_mesh_gen_def_trans_time_srv_t;

/** Parameter of Generic OnPowerUp state */
typedef struct {
    uint8_t onpowerup;      /*!< The value of the Generic OnPowerUp state */
} bfl_ble_mesh_gen_onpowerup_state_t;

/** User data of Generic Power OnOff Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Generic Power OnOff Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_onpowerup_state_t *state;  /*!< Parameters of the Generic OnPowerUp state */
} bfl_ble_mesh_gen_power_onoff_srv_t;

/** User data of Generic Power OnOff Setup Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Generic Power OnOff Setup Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_onpowerup_state_t *state;  /*!< Parameters of the Generic OnPowerUp state */
} bfl_ble_mesh_gen_power_onoff_setup_srv_t;
...
} bfl_ble_mesh_gen_power_level_state_t;

/** User data of Generic Power Level Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Power Level Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_power_level_state_t *state;    /*!< Parameters of the Generic Power Level state */
    bfl_ble_mesh_last_msg_info_t last;              /*!< Parameters of the last received set message */
    bfl_ble_mesh_state_transition_t transition;     /*!< Parameters of state transition */
    int32_t tt_delta_level;                         /*!< Delta change value of level state transition */
} bfl_ble_mesh_gen_power_level_srv_t;

/** User data of Generic Power Level Setup Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Power Level Setup Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_power_level_state_t *state;    /*!< Parameters of the Generic Power Level state */
} bfl_ble_mesh_gen_power_level_setup_srv_t;
...
} bfl_ble_mesh_gen_battery_state_t;

/** User data of Generic Battery Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Generic Battery Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_battery_state_t state;     /*!< Parameters of the Generic Battery state */
} bfl_ble_mesh_gen_battery_srv_t;
...
} bfl_ble_mesh_gen_location_state_t;

/** User data of Generic Location Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Generic Location Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_location_state_t *state;   /*!< Parameters of the Generic Location state */
} bfl_ble_mesh_gen_location_srv_t;

/** User data of Generic Location Setup Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Generic Location Setup Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    bfl_ble_mesh_gen_location_state_t *state;   /*!< Parameters of the Generic Location state */
} bfl_ble_mesh_gen_location_setup_srv_t;

/** This enum value is the access value of Generic User Property */
typedef enum {
    BFL_BLE_MESH_GEN_USER_ACCESS_PROHIBIT,
    BFL_BLE_MESH_GEN_USER_ACCESS_READ,
    BFL_BLE_MESH_GEN_USER_ACCESS_WRITE,
    BFL_BLE_MESH_GEN_USER_ACCESS_READ_WRITE,
} bfl_ble_mesh_gen_user_prop_access_t;

/** This enum value is the access value of Generic Admin Property */
typedef enum {
    BFL_BLE_MESH_GEN_ADMIN_NOT_USER_PROP,
    BFL_BLE_MESH_GEN_ADMIN_ACCESS_READ,
    BFL_BLE_MESH_GEN_ADMIN_ACCESS_WRITE,
    BFL_BLE_MESH_GEN_ADMIN_ACCESS_READ_WRITE,
} bfl_ble_mesh_gen_admin_prop_access_t;

/** This enum value is the access value of Generic Manufacturer Property */
typedef enum {
    BFL_BLE_MESH_GEN_MANU_NOT_USER_PROP,
    BFL_BLE_MESH_GEN_MANU_ACCESS_READ,
} bfl_ble_mesh_gen_manu_prop_access_t;
...
} bfl_ble_mesh_generic_property_t;

/** User data of Generic User Property Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                    /*!< Pointer to the Generic User Property Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    uint8_t property_count;                         /*!< Generic User Property count */
    bfl_ble_mesh_generic_property_t *properties;    /*!< Parameters of the Generic User Property state */
} bfl_ble_mesh_gen_user_prop_srv_t;

/** User data of Generic Admin Property Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Admin Property Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    uint8_t property_count;                         /*!< Generic Admin Property count */
    bfl_ble_mesh_generic_property_t *properties;    /*!< Parameters of the Generic Admin Property state */
} bfl_ble_mesh_gen_admin_prop_srv_t;

/** User data of Generic Manufacturer Property Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Manufacturer Property Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    uint8_t property_count;                         /*!< Generic Manufacturer Property count */
    bfl_ble_mesh_generic_property_t *properties;    /*!< Parameters of the Generic Manufacturer Property state */
} bfl_ble_mesh_gen_manu_prop_srv_t;

/** User data of Generic Client Property Server Model */
typedef struct {
    bfl_ble_mesh_model_t *model;                /*!< Pointer to the Generic Client Property Server Model. Initialized internally. */
    bfl_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    uint8_t id_count;                           /*!< Generic Client Property ID count */
    uint16_t *property_ids;                     /*!< Parameters of the Generic Client Property state */
} bfl_ble_mesh_gen_client_prop_srv_t;

/** Parameter of Generic OnOff Set state change event */
typedef struct {
    uint8_t onoff;          /*!< The value of Generic OnOff state */
} bfl_ble_mesh_state_change_gen_onoff_set_t;

/** Parameter of Generic Level Set state change event */
typedef struct {
    int16_t level;          /*!< The value of Generic Level state */
} bfl_ble_mesh_state_change_gen_level_set_t;

/** Parameter of Generic Delta Set state change event */
typedef struct {
    int16_t level;          /*!< The value of Generic Level state */
} bfl_ble_mesh_state_change_gen_delta_set_t;

/** Parameter of Generic Move Set state change event */
typedef struct {
    int16_t level;          /*!< The value of Generic Level state */
} bfl_ble_mesh_state_change_gen_move_set_t;
...
} bfl_ble_mesh_state_change_gen_power_range_set_t;
...
} bfl_ble_mesh_state_change_gen_loc_global_set_t;
...
} bfl_ble_mesh_state_change_gen_loc_local_set_t;
...
} bfl_ble_mesh_state_change_gen_user_property_set_t;
...
} bfl_ble_mesh_state_change_gen_admin_property_set_t;
...
} bfl_ble_mesh_state_change_gen_manu_property_set_t;
...
typedef union {
     ...
     */
    bfl_ble_mesh_state_change_gen_onoff_set_t          onoff_set;           /*!< Generic OnOff Set */
    bfl_ble_mesh_state_change_gen_level_set_t          level_set;           /*!< Generic Level Set */
    bfl_ble_mesh_state_change_gen_delta_set_t          delta_set;           /*!< Generic Delta Set */
    bfl_ble_mesh_state_change_gen_move_set_t           move_set;            /*!< Generic Move Set */
    bfl_ble_mesh_state_change_gen_def_trans_time_set_t def_trans_time_set;  /*!< Generic Default Transition Time Set */
    bfl_ble_mesh_state_change_gen_onpowerup_set_t      onpowerup_set;       /*!< Generic OnPowerUp Set */
    bfl_ble_mesh_state_change_gen_power_level_set_t    power_level_set;     /*!< Generic Power Level Set */
    bfl_ble_mesh_state_change_gen_power_default_set_t  power_default_set;   /*!< Generic Power Default Set */
    bfl_ble_mesh_state_change_gen_power_range_set_t    power_range_set;     /*!< Generic Power Range Set */
    bfl_ble_mesh_state_change_gen_loc_global_set_t     loc_global_set;      /*!< Generic Location Global Set */
    bfl_ble_mesh_state_change_gen_loc_local_set_t      loc_local_set;       /*!< Generic Location Local Set */
    bfl_ble_mesh_state_change_gen_user_property_set_t  user_property_set;   /*!< Generic User Property Set */
    bfl_ble_mesh_state_change_gen_admin_property_set_t admin_property_set;  /*!< Generic Admin Property Set */
    bfl_ble_mesh_state_change_gen_manu_property_set_t  manu_property_set;   /*!< Generic Manufacturer Property Set */
} bfl_ble_mesh_generic_server_state_change_t;

/** Context of the received Generic User Property Get message */
typedef struct {
    uint16_t property_id;       /*!< Property ID identifying a Generic User Property */
} bfl_ble_mesh_server_recv_gen_user_property_get_t;

/** Context of the received Generic Admin Property Get message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic Admin Property */
} bfl_ble_mesh_server_recv_gen_admin_property_get_t;

/** Context of the received Generic Manufacturer Property message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic Manufacturer Property */
} bfl_ble_mesh_server_recv_gen_manufacturer_property_get_t;

/** Context of the received Generic Client Properties Get message */
typedef struct {
    uint16_t property_id;   /*!< A starting Client Property ID present within an element */
} bfl_ble_mesh_server_recv_gen_client_properties_get_t;

/**
 * @brief Generic Server Model received get message union
 */
typedef union {
    bfl_ble_mesh_server_recv_gen_user_property_get_t         user_property;     /*!< Generic User Property Get */
    bfl_ble_mesh_server_recv_gen_admin_property_get_t        admin_property;    /*!< Generic Admin Property Get */
    bfl_ble_mesh_server_recv_gen_manufacturer_property_get_t manu_property;     /*!< Generic Manufacturer Property Get */
    bfl_ble_mesh_server_recv_gen_client_properties_get_t     client_properties; /*!< Generic Client Properties Get */
} bfl_ble_mesh_generic_server_recv_get_msg_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} bfl_ble_mesh_server_recv_gen_onoff_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} bfl_ble_mesh_server_recv_gen_level_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} bfl_ble_mesh_server_recv_gen_delta_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} bfl_ble_mesh_server_recv_gen_move_set_t;

/** Context of the received Generic Default Transition Time Set message */
typedef struct {
    uint8_t trans_time;     /*!< The value of the Generic Default Transition Time state */
} bfl_ble_mesh_server_recv_gen_def_trans_time_set_t;

/** Context of the received Generic OnPowerUp Set message */
typedef struct {
    uint8_t onpowerup;      /*!< The value of the Generic OnPowerUp state */
} bfl_ble_mesh_server_recv_gen_onpowerup_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} bfl_ble_mesh_server_recv_gen_power_level_set_t;

/** Context of the received Generic Power Default Set message */
typedef struct {
    uint16_t power;         /*!< The value of the Generic Power Default state */
} bfl_ble_mesh_server_recv_gen_power_default_set_t;

/** Context of the received Generic Power Range Set message */
typedef struct {
    uint16_t range_min;     /*!< Value of Range Min field of Generic Power Range state */
    uint16_t range_max;     /*!< Value of Range Max field of Generic Power Range state */
} bfl_ble_mesh_server_recv_gen_power_range_set_t;
...
typedef struct {
    ...
    int32_t global_longitude;   /*!< Global Coordinates (Longitude) */
    int16_t global_altitude;    /*!< Global Altitude */
} bfl_ble_mesh_server_recv_gen_loc_global_set_t;
...
typedef struct {
    ...
    uint8_t  floor_number;      /*!< Floor Number */
    uint16_t uncertainty;       /*!< Uncertainty */
} bfl_ble_mesh_server_recv_gen_loc_local_set_t;

/** Context of the received Generic User Property Set message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic User Property */
    struct net_buf_simple *property_value;  /*!< Raw value for the User Property */
} bfl_ble_mesh_server_recv_gen_user_property_set_t;
...
typedef struct {
    ...
    uint8_t  user_access;   /*!< Enumeration indicating user access */
    struct net_buf_simple *property_value;  /*!< Raw value for the Admin Property */
} bfl_ble_mesh_server_recv_gen_admin_property_set_t;

/** Context of the received Generic Manufacturer Property Set message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic Manufacturer Property */
    uint8_t  user_access;   /*!< Enumeration indicating user access */
} bfl_ble_mesh_server_recv_gen_manufacturer_property_set_t;

/**
 * @brief Generic Server Model received set message union
 */
typedef union {
    bfl_ble_mesh_server_recv_gen_onoff_set_t                 onoff;             /*!< Generic OnOff Set/Generic OnOff Set Unack */
    bfl_ble_mesh_server_recv_gen_level_set_t                 level;             /*!< Generic Level Set/Generic Level Set Unack */
    bfl_ble_mesh_server_recv_gen_delta_set_t                 delta;             /*!< Generic Delta Set/Generic Delta Set Unack */
    bfl_ble_mesh_server_recv_gen_move_set_t                  move;              /*!< Generic Move Set/Generic Move Set Unack */
    bfl_ble_mesh_server_recv_gen_def_trans_time_set_t        def_trans_time;    /*!< Generic Default Transition Time Set/Generic Default Transition Time Set Unack */
    bfl_ble_mesh_server_recv_gen_onpowerup_set_t             onpowerup;         /*!< Generic OnPowerUp Set/Generic OnPowerUp Set Unack */
    bfl_ble_mesh_server_recv_gen_power_level_set_t           power_level;       /*!< Generic Power Level Set/Generic Power Level Set Unack */
    bfl_ble_mesh_server_recv_gen_power_default_set_t         power_default;     /*!< Generic Power Default Set/Generic Power Default Set Unack */
    bfl_ble_mesh_server_recv_gen_power_range_set_t           power_range;       /*!< Generic Power Range Set/Generic Power Range Set Unack */
    bfl_ble_mesh_server_recv_gen_loc_global_set_t            location_global;   /*!< Generic Location Global Set/Generic Location Global Set Unack */
    bfl_ble_mesh_server_recv_gen_loc_local_set_t             location_local;    /*!< Generic Location Local Set/Generic Location Local Set Unack */
    bfl_ble_mesh_server_recv_gen_user_property_set_t         user_property;     /*!< Generic User Property Set/Generic User Property Set Unack */
    bfl_ble_mesh_server_recv_gen_admin_property_set_t        admin_property;    /*!< Generic Admin Property Set/Generic Admin Property Set Unack */
    bfl_ble_mesh_server_recv_gen_manufacturer_property_set_t manu_property;     /*!< Generic Manufacturer Property Set/Generic Manufacturer Property Set Unack */
} bfl_ble_mesh_generic_server_recv_set_msg_t;

/**
 * @brief Generic Server Model callback value union
 */
typedef union {
    bfl_ble_mesh_generic_server_state_change_t state_change;    /*!< BFL_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT */
    bfl_ble_mesh_generic_server_recv_get_msg_t get;     /*!< BFL_BLE_MESH_GENERIC_SERVER_RECV_GET_MSG_EVT */
    bfl_ble_mesh_generic_server_recv_set_msg_t set;     /*!< BFL_BLE_MESH_GENERIC_SERVER_RECV_SET_MSG_EVT */
} bfl_ble_mesh_generic_server_cb_value_t;

/** Generic Server Model callback parameters */
typedef struct {
    bfl_ble_mesh_model_t  *model;   /*!< Pointer to Generic Server Models */
    bfl_ble_mesh_msg_ctx_t ctx;     /*!< Context of the received messages */
    bfl_ble_mesh_generic_server_cb_value_t value;   /*!< Value of the received Generic Messages */
} bfl_ble_mesh_generic_server_cb_param_t;
...
typedef enum {
     ...
     *    are received.
     */
    BFL_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT,
    /**
     * When get_auto_rsp is set to BFL_BLE_MESH_SERVER_RSP_BY_APP, this event will be
     * callback to the application layer when Generic Get messages are received.
     */
    BFL_BLE_MESH_GENERIC_SERVER_RECV_GET_MSG_EVT,
    /**
     ...
     */
    BFL_BLE_MESH_GENERIC_SERVER_RECV_SET_MSG_EVT,
    BFL_BLE_MESH_GENERIC_SERVER_EVT_MAX,
} bfl_ble_mesh_generic_server_cb_event_t;
 ...
 * @param   param: Pointer to callback parameter
 */
typedef void (* bfl_ble_mesh_generic_server_cb_t)(bfl_ble_mesh_generic_server_cb_event_t event,
 ...
 *
 */
bfl_err_t bfl_ble_mesh_register_generic_server_callback(bfl_ble_mesh_generic_server_cb_t callback);

#ifdef __cplusplus
}
#endif

#endif /* _BFL_BLE_MESH_GENERIC_MODEL_API_H_ */
